...
bg2 = pygame.image.load("Screen/bg2.png")
...
#Game Title
pygame.display.set_caption("Snake By Team 1")
...
def plot_snake(gameWindow, color, snk_list, snake_size):
   for x,y in snk_list:
        pygame.draw.rect(gameWindow, color, [x,y,30,30], 0, 5)
...
#GameOverScreen
           ...
           text_screen("Score: " + str(score ), snakegreen, 400, 375)
           for event in pygame.event.get():
               if event.type == pygame.QUIT:
                   exit_game = True
               if event.type == pygame.KEYDOWN:
